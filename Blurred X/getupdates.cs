...
namespace Terbium
{
    public partial class getupdates : Form
    {
        ...
        {
            string markdownUrl = "https://cdn.z1g-project.repl.co/z1g-hub/client/blurredx-changelog.md";
        ...
        private void Button1_Click_1(object sender, EventArgs e)
        {
            ...
            string updateUrl = "https://tb-client.johnglynn2.repl.co/bx.zip";
            string zipFilePath = @"C:\z1g Apps\Blurred X\update.zip"; // Path to save the downloaded zip file
            ...
            string extractPath = @"C:\z1g Apps\Blurred X\"; // Path to extract the zip contents
